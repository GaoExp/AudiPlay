...
└── app/
    ...
    │
    └── src/main/
        ├── AndroidManifest.xml      — Manifest: permissions audio/video/images/notifikasi/BT/baterai, 5 activity-alias ikon, 7 Activity, MusicService
        │
        ├── assets/
...
│   │   ├── settings/
│   │   │   ├── SettingsFragment.java     — Fragment pengaturan: screen-on, audio focus, batasi folder, format audio, ikon aplikasi, kelola izin, hemat baterai, dokumentasi
...
│   │   │   ├── SongsViewModel.java       — ViewModel daftar lagu dengan filter, sorting, scan-once logic
        ...
        │       ├── PermissionHelper.java         — Handler izin runtime: audio/video/images, notifikasi, requestAllPermissions() untuk first-run
        ...
        │       ├── fragment_settings.xml          — Layout settings (ScrollView, card: Playback, Storage, Izin, Appearance, Documentation)
