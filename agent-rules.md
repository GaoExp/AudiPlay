...
- Build / revert tanpa konfirmasi. Revert wajib konfirmasi. Build **hanya saat diperintah langsung** user — jangan meminta izin/konfirmasi untuk build, cukup diam. Verifikasi cepat via inspeksi (grep/diff).
...
- Build project hanya dilakukan lewat `./gradlew` saat diperintah langsung oleh user.
