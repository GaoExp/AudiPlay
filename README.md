...
Izin diminta otomatis saat pertama aplikasi dibuka. Pengguna juga bisa mengelola izin & nonaktifkan optimasi baterai melalui menu **Pengaturan**.
...
└── app/
    ...
    └── src/main/
        ...
        │   │   ├── documentation/
        │   │   │   └── DocumentationActivity.java — Baca file .txt dari assets (README, PANDUAN, CHANGELOG)
        │   │   ├── favorites/
        ...
        └── res/
            ...
            │   ├── ic_launcher_round.xml         — Default round adaptive icon
            │   ├── ic_launcher_note.xml          — "Nota Musik" adaptive icon
            │   ├── ic_launcher_note_round.xml    — "Nota Musik" round
            │   ├── ic_launcher_note_dark.xml     — "Nota Musik (Gelap)" adaptive
            │   ├── ic_launcher_note_dark_round.xml
            │   ├── ic_launcher_play.xml          — "Putar" adaptive icon
            │   ├── ic_launcher_play_round.xml    — "Putar" round
            │   ├── ic_launcher_play_dark.xml     — "Putar (Gelap)" adaptive
            │   ├── ic_launcher_play_dark_round.xml
            │   ├── ic_launcher_queue.xml         — "Antrian" adaptive icon
            │   └── ic_launcher_queue_round.xml   — "Antrian" round
            │
