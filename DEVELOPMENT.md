...
Project menggunakan versioning format: `major.removed.restored.minor.patch`

| Komponen  | Arti                                    |
|-----------|-----------------------------------------|
| major     | Milestone besar / arsitektur            |
| removed   | Counter fitur yang dihapus              |
| restored  | Counter fitur yang dipulihkan           |
...
- `removed` dan `restored` tidak pernah turun
