...
- **Ikon Aplikasi** — Pilih dari 22 ikon untuk aplikasi di layar utama (Nota Musik, Putar, Nota Musik Gelap, Putar Gelap, Antrian, +17 ikon dekoratif)
...
- **Dokumentasi** — Buka pembaca dokumentasi in-app (README, PANDUAN, STRUKTUR, CHANGELOG) dengan render Markdown
