...
- **Kustomisasi Ikon** — 22 pilihan ikon aplikasi dari Pengaturan
...
| Markwon (ext-tables)             | 4.6.2   | Markdown table plugin       |
| Markwon (ext-tasklist)           | 4.6.2   | Markdown task list plugin   |
